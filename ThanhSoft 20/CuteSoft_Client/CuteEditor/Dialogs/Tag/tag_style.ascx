...
<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1004&file=Dialog_Tag_Style.js"></script>
...
var OxOf846=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOf846[1],true)[OxOf846[0]]=function (){if(event[OxOf846[2]]){alert(element[OxOf846[3]].cssText);} ;} ;
</script>
