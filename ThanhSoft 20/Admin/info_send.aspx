<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageqtri.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="info_send.aspx.cs" Inherits="Admin_info_send"  %>
			...
			<div class="padding" style="width:100%; margin:1px auto;">
				<div id="toolbar-box" >
			        ...
			        <div class="m">
				        ...
				        <div class="header icon-48-cpanel">Đăng tin tức</div>
				        <div class="clr"></div>
			        </div>
			        <div class="b">
				        <div class="b">
