<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageqtri.master" AutoEventWireup="true" CodeFile="info_list.aspx.cs" Inherits="Admin_info_list" %>
			...
			<div class="padding" style="width:100%; margin:1px auto;">
				<div id="toolbar-box" >
			        ...
			        <div class="m">
                            ...
                            <table class="toolbar">
                                <tr>
                                    ...
                                    <td class="button" id="toolbar-delete">
                                        <asp:LinkButton ID="btnDeleteAll" Visible="true" runat="server"  
                                            CssClass="toolbar" OnClientClick="return cfDeleteAll();" 
				        ...
				        <div class="header icon-48-cpanel">Danh sách tin tức đã đăng</div>
				        <div class="clr"></div>
			        </div>
			        <div class="b">
				        <div class="b">
				                        ...
				                        <tr>	
				                             <td align="right">
				                                <asp:TextBox ID="txtSearch" runat="server" Width="150px"></asp:TextBox>				                            
                                                 <asp:DropDownList ID="ddlDichvu" runat="server" Width="150px">
                                                    <asp:ListItem Text="Tin giáo dục" Value="0" Selected="True"></asp:ListItem>   
                                                    <asp:ListItem Text="Tin công nghệ" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="Tin thể thao" Value="2"></asp:ListItem>
                                                    <asp:ListItem Text="Tin âm nhạc - phim ảnh" Value="3"></asp:ListItem>                                                   
                                                </asp:DropDownList>
                                    ...
                                    <asp:Repeater id="rptTieuDe" runat="server">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr class='<%# (Container.ItemIndex % 2 == 0) ? "row0" : "row1"%>'>
                                                ...
                                                <a href="info_send.aspx?info_id=<%# DataBinder.Eval(Container.DataItem,"tintuc_id")%>"><%# DataBinder.Eval(Container.DataItem, "tieude")%></a></td>
