<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageqtri.master" AutoEventWireup="true" CodeFile="cat_service.aspx.cs" Inherits="Admin_cat_service" %>
			...
			<div class="padding" style="width:100%; margin:1px auto;">
				<div id="toolbar-box" >
			        ...
			        <div class="m">
				        ...
				        <div class="header icon-48-cpanel">Danh mục  dịch vụ</div>
				        <div class="clr"></div>
			        </div>
			        <div class="b">
				        <div class="b">
                                    ...
                                    <asp:Repeater id="rptProduct" runat="server">
                                        ...
                                        <table cellspacing="1" class="adminlist">
                                            ...
                                            <tr>
                                                ...
                                                <th width="5"> STT </th>
                                                <th class="title" nowrap>Tên  dịch vụ</th> 
                                            </tr>
                                            </thead>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            ...
                                            <tr class='<%# (Container.ItemIndex % 2 == 0) ? "row0" : "row1"%>'>
                                                ...
                                                <td align="left" nowrap>
                                                    <asp:Label ID="lblHangHoaID" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"loaidv_id")%>' Visible="false"></asp:Label>
                                                <a href="cat_service.aspx?dichvu_ma=<%# DataBinder.Eval(Container.DataItem,"loaidv_id")%>"><%# DataBinder.Eval(Container.DataItem, "tendv")%></a></td>
