<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageqtri.master" AutoEventWireup="true" CodeFile="price_list.aspx.cs" Inherits="Admin_Default2" %>
			...
			<div class="padding" style="width:100%; margin:1px auto;">
				<div id="toolbar-box" >
			        ...
			        <div class="m">
				        ...
				        <div class="header icon-48-price">Danh sách bảng giá</div>
				        <div class="clr"></div>
			        </div>
			        <div class="b">
				        <div class="b">
		        ...
		        <div id="element-box" >
			        ...
			        <div class="m">
                            ...
                            <div class="col00">
                                  <fieldset class="adminform">
				                    <legend>Danh sách các bảng giá gói thiết kế của Thanhsoft</legend>
                                    <asp:Repeater id="rptTieuDe" runat="server">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <tr class='<%# (Container.ItemIndex % 2 == 0) ? "row0" : "row1"%>'>
                                                ...
                                                <a href="updateprice.aspx?info_id=<%# DataBinder.Eval(Container.DataItem,"id")%>"><%# DataBinder.Eval(Container.DataItem, "tengoi")%></a></td>
