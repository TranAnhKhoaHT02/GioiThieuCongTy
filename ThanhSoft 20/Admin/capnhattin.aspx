<%@ Page Language="C#" MasterPageFile="~/Admin/MasterPageqtri.master" AutoEventWireup="true" CodeFile="capnhattin.aspx.cs" Inherits="Admin_Default2"  %>
<%@ Register Assembly="CuteEditor" Namespace="CuteEditor" TagPrefix="thanhsoft" %>
		                    ...
		                    <div class="col00">
			                    <fieldset class="adminform" >			                    
				                    ...
				                    <table class="admintable" cellspacing="1" width="100%">				                       
				                        <tr>
                                            ...
                                            <td >
                                                <asp:DropDownList ID="ddlDichvu" runat="server" 
                                                    DataValueField="dichvu_ma" DataTextField="dichvu_ten" 
					                    ...
					                    <tr>
						                    <td class="key" style="vertical-align:top">Heading bài viết</td>
						                    <td colspan="10">						                                                                      
